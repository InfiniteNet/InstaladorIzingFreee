...
system_git_clone() {
  print_banner
  printf "${WHITE} 💻 Instalador Versão Open Comunidade ...${GRAY_LIGHT}"
  printf "\n\n"
...
system_git_clone_instancia() {
  ...
  sleep 2
  sudo su - deploy <<EOF
  git clone https://github.com/marqneto/izing.open.io /home/deploy/$instancia/
...
renovar_certificado() {
  print_banner
  printf "${WHITE} 💻 Renovando certbot...${GRAY_LIGHT}"
  printf "\n\n"
