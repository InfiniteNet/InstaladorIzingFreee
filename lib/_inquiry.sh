...
get_instancia_nome() {
  ...
  print_banner
  printf "${WHITE} 💻 Digite o nome da Instancia exemplo izing2 ou izing3........${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " instancia
}
...
get_db_user1() {
  ...
  print_banner
  printf "${WHITE} 💻 Digite o usuario usado na instalacao principal do Izing do Banco de Dados:${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " db_user
}
...
get_db_pass1() {
  ...
  print_banner
  printf "${WHITE} 💻 Digite a senha usada no seu Banco de Dados da instalacao do izing principal:  ${GRAY_LIGHT}"
  printf "\n\n"
  read -p "> " db_pass
}
